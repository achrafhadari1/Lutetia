  ...
  const blogPosts = [
    {
      ...
      excerpt: "How the design of movie theaters has transformed our relationship with film over the last century, from grand movie palaces to brutalist monuments.",
      author: "Sophia Laurent",
      date: "June 10, 2025",
      category: "ARCHITECTURE",
      image: "https://images.pexels.com/photos/2563339/pexels-photo-2563339.jpeg",
      featured: true
    },
    {
      id: 2,
      title: "DIRECTORS TO WATCH: THE NEW WAVE OF EXPERIMENTAL CINEMA",
      excerpt: "We spotlight five emerging directors who are pushing the boundaries of conventional filmmaking with their unconventional approaches to narrative and form.",
    ...
    },
    {
      ...
      excerpt: "Behind the scenes with the technicians and artists who work tirelessly to restore and preserve classic films for future generations.",
    ...
    },
    {
      ...
      excerpt: "How contemporary filmmakers are revisiting the silent film format to create powerful visual storytelling without dialogue.",
      author: "Thomas Noir",
      date: "May 15, 2025",
    ...
    },
    {
      ...
      excerpt: "Award-winning cinematographer Lucas Debois discusses his approach to visual storytelling and his collaborations with leading directors.",
      author: "Marie Clément",
      date: "May 3, 2025",
      category: "INTERVIEW",
      image: "https://images.pexels.com/photos/2346001/pexels-photo-2346001.jpeg"
    }
  ];
    ...
    <div className="brutalist-blog">
      ...
      <nav className="brutalist-nav">
        <div className="nav-container">
          <Link to="/" className="logo">LUTETIA</Link>
        ...
        <div className="brutalist-container">
          <div className="grid grid-cols-12 gap-8">
            <div className="col-span-8 col-start-3">
              ...
              <h1 className="font-heading text-8xl tracking-wider mb-8">BLOG</h1>
      ...
      {blogPosts.filter(post => post.featured).map(post => (
        <div key={post.id} className="brutalist-featured-post py-16 bg-black relative">
            ...
            <div className="grid grid-cols-12 gap-8">
              ...
              <div className="col-span-4">
                ...
                <div className="brutalist-button-small">
                  <span className="brutalist-button-inner-small">READ MORE</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="brutalist-container">
          <div className="grid grid-cols-12 gap-12">
            <div className="col-span-12 mb-8">
              <h2 className="font-heading text-5xl tracking-wider">LATEST ARTICLES</h2>
            </div>
            ...
            {blogPosts.filter(post => !post.featured).map(post => (
              <div key={post.id} className="col-span-6">
                <div className="brutalist-blog-card">
                  ...
                  <div className="font-mono text-sm mb-2">{post.category}</div>
            ...
            <div className="col-span-12 mt-12 text-center">
              <div className="brutalist-button inline-block">
                <span className="brutalist-button-inner">VIEW ALL ARTICLES</span>
              </div>
            </div>
          </div>
        </div>
