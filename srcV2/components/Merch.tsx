  ...
  const merchandise = [
    {
      ...
      price: 45,
      category: "posters",
      image: "https://images.pexels.com/photos/6474494/pexels-photo-6474494.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
    },
    {
      id: 2,
    ...
    },
    {
      ...
      price: 30,
      category: "accessories",
      image: "https://images.pexels.com/photos/5662862/pexels-photo-5662862.png?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
    },
    {
      id: 6,
            ...
            <>
              ...
              <div className="mt-8 pt-4 border-t border-black">
                ...
                <div className="brutalist-button-small w-full text-center">
                  <span className="brutalist-button-inner-small block">CHECKOUT</span>
                </div>
              </div>
            </>
          )}
        ...
        <div className="brutalist-container">
          <div className="grid grid-cols-12 gap-8">
            <div className="col-span-8 col-start-3">
              ...
              <h1 className="font-heading text-8xl tracking-wider mb-8">MERCHANDISE</h1>
          ...
          <div className="grid grid-cols-12 gap-8">
            ...
            <div className="col-span-12 mb-12">
              <div className="flex justify-center gap-8 font-mono">
                {['all', 'posters', 'books', 'apparel', 'accessories'].map(filter => (
                  <div 
                    key={filter}
                    className={`brutalist-filter cursor-pointer uppercase ${activeFilter === filter ? 'border-b-2 border-white' : ''}`}
            ...
            {filteredItems.map(item => (
              <div key={item.id} className="col-span-4 mb-16">
                <div className="brutalist-merch-item">
                  ...
                  >
                    <span className="brutalist-button-inner-small">ADD TO CART</span>
                  </div>
                </div>
              </div>
            ))}
