...
export const Details = ({ id }) => {
  ...
  if (loading) {
    return <div className="h-40 flex items-center justify-center">Loading movie details...</div>;
  }

  if (!movieDetails) {
    return <div className="h-40 flex items-center justify-center">Movie details not available</div>;
  }
        ...
        <div className="grid grid-cols-12 gap-8">
          <div className="col-span-7">
            <div className="brutalist-details-section">
              <h2 className="font-heading text-5xl tracking-wider mb-12 text-black">DETAILS</h2>
              
              <div className="brutalist-details-grid grid gap-6">
                <div className="brutalist-details-item border-t-2 border-black pt-4">
                  <div className="font-heading text-3xl mb-2">ORIGINAL LANGUAGE</div>
                  <div className="font-serif text-xl">
                    {movieDetails.originalLanguage === "en" ? "English" : movieDetails.originalLanguage}
                  </div>
                </div>
                
                <div className="brutalist-details-item border-t-2 border-black pt-4">
                  <div className="font-heading text-3xl mb-2">GENRE</div>
                  <div className="font-serif text-xl">{movieDetails.genres}</div>
                </div>
                
                <div className="brutalist-details-item border-t-2 border-black pt-4">
                  <div className="font-heading text-3xl mb-2">RELEASE DATE</div>
                  <div className="font-serif text-xl">{movieDetails.releaseDate}</div>
                </div>
                ...
                <div className="brutalist-details-item border-t-2 border-black pt-4">
                  ...
                  <div className="font-serif text-xl">{formatCurrency(movieDetails.budget)}</div>
                </div>
                
                <div className="brutalist-details-item border-t-2 border-black pt-4">
                  <div className="font-heading text-3xl mb-2">REVENUE</div>
                  <div className="font-serif text-xl">{formatCurrency(movieDetails.revenue)}</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="col-span-12 mt-16">
            <h2 className="font-heading text-5xl tracking-wider mb-12 text-black">CAST</h2>
