    ...
    <div className="brutalist-movie-page">
      ...
      <nav className="brutalist-nav">
        <div className="nav-container">
          <Link to="/" className="logo-back flex items-center gap-2">
            <ArrowLeft size={24} />
      ...
      {/* Hero Section */}
      <div className="brutalist-movie-hero relative vh-95">
        <div 
        ...
        <div className="relative z-10 h-full pt-32 pb-16 px-16 grid grid-cols-12 gap-4">
          <div className="col-span-5 col-start-2">
            <div className="uppercase tracking-widest text-sm font-mono border-l-2 border-white pl-4 mb-6">
              LUTETIA PRESENTS
            </div>
            
            <h1 className="font-heading text-7xl tracking-wider mb-8">{movie.title}</h1>
            
            <div className="text-lg font-light mb-6 font-mono uppercase tracking-wider">
              {movie.genres.map(g => g.name).join(", ")} | {movie.adult ? "R" : "PG-13"}
            </div>
          ...
          <div className="brutalist-container">
            <div className="grid grid-cols-12 gap-8">
              <div className="col-span-10 col-start-2">
                <h2 className="font-heading text-5xl tracking-wider mb-12">OFFICIAL TRAILER</h2>
